...
const menus = {
  ...
  safari: {
    ...
    url: "/safaris",
    items: [
      { label: "OKAVANGO DELTA BY MOKORO + MOREMI TRIP", key: "1", description: "Exhilarating canoe rides, Spectacular views of the delta, Close encounter with nature, Variety of bird species, Walking safari, Moremi day trip", url: "/safaris" },
